...
import static smile.data.formula.Terms.abs;
import static smile.data.formula.Terms.add;
import static smile.data.formula.Terms.all;
import static smile.data.formula.Terms.ceil;
import static smile.data.formula.Terms.cross;
import static smile.data.formula.Terms.date;
import static smile.data.formula.Terms.delete;
import static smile.data.formula.Terms.div;
import static smile.data.formula.Terms.exp;
import static smile.data.formula.Terms.floor;
import static smile.data.formula.Terms.interact;
import static smile.data.formula.Terms.log;
import static smile.data.formula.Terms.log10;
import static smile.data.formula.Terms.mul;
import static smile.data.formula.Terms.onehot;
import static smile.data.formula.Terms.round;
import static smile.data.formula.Terms.signum;
import static smile.data.formula.Terms.sqrt;
import static smile.data.formula.Terms.sub;
import static smile.data.formula.Terms.val;
...
public class FormulaSerializationTest {
    ...
    public FormulaSerializationTest() {
    ...
    public void testAll() {
        ...
        Formula formula = serializeDeserialize(Formula.of("salary", all(), log("age"), onehot("gender")));
    ...
    public void testFormula() {
        ...
        Formula formula = serializeDeserialize(Formula.of("salary", $("age")));
    ...
    public void testInteraction() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(interact("water", "sowing_density", "wind")));
    ...
    public void testCrossing() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(cross(2, "water", "sowing_density", "wind")));
        StructType inputSchema = DataTypes.struct(
                new StructField("water", DataTypes.ByteType, new NominalScale("dry", "wet")),
                new StructField("sowing_density", DataTypes.ByteType, new NominalScale("low", "high")),
                new StructField("wind", DataTypes.ByteType, new NominalScale("weak", "strong"))
        ...
        formula = serializeDeserialize(Formula.rhs(cross("water", "sowing_density", "wind")));
    ...
    public void testBind() {
        ...
        Formula formula = serializeDeserialize(Formula.of("revenue", all(), cross("water", "sowing_density") , mul("humidity", "wind"), delete("wind")));
        StructType inputSchema = DataTypes.struct(
    ...
    public void testFormulaOneHot() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(onehot("gender")));
    ...
    public void testFormulaDate() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(date("birthday", DateFeature.YEAR, DateFeature.MONTH, DateFeature.DAY_OF_MONTH, DateFeature.DAY_OF_WEEK)));
    ...
    public void testFormulaAbs() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(abs("age")));
    ...
    public void testFormulaAbsNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(abs("salary")));
    ...
    public void testFormulaExp() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(exp("age")));
    ...
    public void testFormulaExpNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(exp(div("salary", val(10000)))));
    ...
    public void testFormulaLog() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(log("age")));
    ...
    public void testFormulaLogNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(log("salary")));
    ...
    public void testFormulaLog10() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(log10("age")));
    ...
    public void testFormulaLog10Nullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(log10("salary")));
    ...
    public void testFormulaSqrt() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(sqrt("age")));
    ...
    public void testFormulaSqrtNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(sqrt("salary")));
    ...
    public void testFormulaCeilNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(ceil("salary")));
    ...
    public void testFormulaFloorNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(floor("salary")));
    ...
    public void testFormulaRoundNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(round("salary")));
    ...
    public void testFormulaSignumNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(signum("salary")));
    ...
    public void testFormulaAddCst() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), add("age", val(10))));
    ...
    public void testFormulaAddNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), add("salary", "age")));
        assertEquals(" ~ . + (salary + age)", formula.toString());
    ...
    public void testFormulaSubCst() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), sub("age", val(10))));
        assertEquals(" ~ . + (age - 10)", formula.toString());
    ...
    public void testFormulaSubNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), sub("salary", "age")));
        assertEquals(" ~ . + (salary - age)", formula.toString());
    ...
    public void testFormulaMulCst() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), mul("age", val(10))));
        assertEquals(" ~ . + (age * 10)", formula.toString());
    ...
    public void testFormulaMulNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), mul("salary", "age")));
        assertEquals(" ~ . + (salary * age)", formula.toString());
    ...
    public void testFormulaDivCst() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), div("age", val(10))));
        assertEquals(" ~ . + (age / 10)", formula.toString());
    ...
    public void testFormulaDivNullable() {
        ...
        Formula formula = serializeDeserialize(Formula.rhs(all(), div("salary", "age")));
        assertEquals(" ~ . + (salary / age)", formula.toString());
    ...
    @Test
    public void testSerializeFormula() {
    ...
    private Formula serializeDeserialize(Formula formula) {
		try {
	    	ByteArrayOutputStream baos = new ByteArrayOutputStream();
	    	ObjectOutputStream oos;
			oos = new ObjectOutputStream(baos);
	    	oos.writeObject(formula);
	    	byte[] seri = baos.toByteArray();
	    	ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(seri));
	    	return (Formula) ois.readObject();
		} catch (Exception e) {
